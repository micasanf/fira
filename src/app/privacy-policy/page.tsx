...
const sections: Section[] = [
  {
    ...
    content: (
      <p className="text-muted-foreground">
        At FIRA, we value your privacy. This Privacy Policy document
    ...
    content: (
      <div className="space-y-4">
        <p className="text-muted-foreground leading-relaxed">
          FIRA employs multiple security layers to protect your data in
          transit and at rest.
        </p>
          ...
          {[
            {
              ...
              detail:
                "All chat messages are encrypted on your device using AES-GCM with a 256-bit key before transmission. Our servers relay only ciphertext — FIRA cannot read your messages.",
            },
            {
            ...
            },
            {
              ...
              detail:
                "No raw card data is processed by FIRA servers. All payment flows run through Stripe's PCI-DSS compliant infrastructure.",
            },
          ].map(({ label, detail }) => (
            <div
              key={label}
            ...
            <tbody className="divide-y divide-border">
              {[
                ...
                },
                {
                  ...
                  data: "Plan selection and billing email. Raw card data is processed exclusively by Stripe — FIRA never stores card numbers.",
                },
                {
                  provider: "Brevo",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <div>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl">
              This Privacy Policy explains how FIRA collects, uses, and
        ...
        <div className="grid lg:grid-cols-[220px_1fr] gap-10">
          ...
          <main className="space-y-12">
            ...
            <div className="pt-6 border-t border-border text-center text-sm text-muted-foreground">
              <p>
                By using FIRA, you acknowledge that you have read and

...
const sections: Section[] = [
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          Welcome to FIRA! These Terms of Service govern your use of
          our platform, including all AI-powered tools, communication features,
          and subscription services. By accessing or using FIRA, you
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          As a user of FIRA, you are responsible for maintaining the
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          You agree to use FIRA for lawful purposes only and in a
    ...
    content: (
      <div className="space-y-4">
        <p className="text-muted-foreground leading-relaxed">
          FIRA is a dual-sided, AI-powered career management platform
      ...
      <div className="space-y-4">
        <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20 flex gap-3">
          ...
          <p className="text-sm text-foreground leading-relaxed">
            FIRA integrates <strong>Google Gemini 2.5 Flash</strong>{" "}
        ...
        {[
          {
            ...
            detail:
              "ATS scores, job match rankings, cover letters, interview question sets, salary estimates, and all other AI-generated outputs are guidance only. FIRA makes no representation or warranty regarding interview outcomes, job placement success, or hiring decisions.",
          },
          {
            ...
            <tbody className="divide-y divide-border">
              {[
                ...
                },
                {
                  ...
                  detail:
                    "By subscribing, you authorize FIRA to charge your payment method on a recurring basis at the interval selected. Charges are processed via Stripe.",
                },
                {
                  topic: "Rate Limiting",
                  detail:
      ...
      <div className="space-y-4">
        <div className="p-4 rounded-lg border border-border bg-muted/50">
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            FIRA expressly disclaims all warranties, express or
        ...
        <div className="p-4 rounded-lg border border-border bg-muted/50">
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            To the maximum extent permitted by applicable law, FIRA and
        ...
        <div className="p-4 rounded-lg border border-border bg-muted/50">
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            FIRA integrates third-party services including Google
        ...
        <div className="p-4 rounded-lg border border-border bg-muted/50">
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            FIRA's total aggregate liability to you for all claims
  ...
  },
  {
    ...
    content: (
      <p className="text-muted-foreground leading-relaxed">
        You agree to defend, indemnify, and hold harmless FIRA, its
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <Link
          href="https://github.com/micasanf/fira"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <div>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed max-w-2xl">
              These Terms govern your access to and use of the FIRA
        ...
        <div className="grid lg:grid-cols-[220px_1fr] gap-10">
          ...
          <main className="space-y-12">
            ...
            <div className="pt-6 border-t border-border text-center text-sm text-muted-foreground">
              <p>
                By using FIRA, you acknowledge that you have read,

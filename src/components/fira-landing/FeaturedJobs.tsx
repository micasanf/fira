...
const mockJobs: MockJob[] = [
  ...
  { id: '4', title: 'Caregiver / Elderly Care', company: 'King Faisal Specialist Hospital', country: 'saudi_arabia', city: 'Riyadh', flag: '🇸🇦', salaryMin: 1400, salaryMax: 2000, salaryPeriod: 'month', category: 'healthcare', skills: ['Elderly Care', 'CPR', 'First Aid', 'Patient Handling'], isFeatured: false, isUrgent: true, applicants: 38, employmentType: 'Full Time' },

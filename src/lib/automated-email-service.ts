    ...
    <html>
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
          <h1 style="color: #2563eb; margin-bottom: 10px;">🎯 Welcome Back to FIRA!</h1>
        ...
        <div style="background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%); padding: 25px; border-radius: 12px; margin: 20px 0;">
          ...
          <p style="margin: 0 0 15px 0;">Welcome to your FIRA dashboard! Now that you're logged in, let's help you discover amazing opportunities.</p>
        </div>
